...
// set page title
$page_title = "Problem: {$problem->pcode} (CPP14 Config -> Testing)";
...
//saved solution
$fpath = "../../../problems/{$problem->pcode}/drivers/cpp14/testing/{$_SESSION['id']}.txt";
$soln = @fopen($fpath,"a");
@fclose($soln);
$size = filesize($fpath);
if($size)
...
if(isset($_POST['code']))
{
    ...
    $response = $judge->submit_problem($source_code, "CPP14", $problem);
