...
$status = ( $problem->cpp14 ?  "<b>Enabled</b> " : "<b>Disabled</b> " ) . ( $problem->cpp14_ready ? "<big><span class='label label-lg label-success'>Ready</span></big>" : "<big><span class='label label-lg label-danger'>Not Ready</span></big>" );
$btn = $problem->cpp14 ? "class='btn btn-md btn-block btn-danger'" : "class='btn btn-md btn-block btn-primary'";
$new_status = $problem->cpp14 ? "Disable" : "Enable";
$action = $problem->cpp14 ? "disable.php" : "enable.php";
...
//head code
$fpath = "../../../problems/{$problem->pcode}/drivers/cpp14/head.txt";
$size = filesize($fpath);
if($size)
{
    $desc = fopen($fpath,"r");
...
//tail code
$fpath = "../../../problems/{$problem->pcode}/drivers/cpp14/tail.txt";
$size = filesize($fpath);
if($size)
{
    $desc = fopen($fpath,"r");
...
//locked tail code
$fpath = "../../../problems/{$problem->pcode}/drivers/cpp14/locked_tail.txt";
$size = filesize($fpath);
if($size)
{
    $desc = fopen($fpath,"r");
...
<div class='col-md-12'>
    <table class='table table-hover'>
        ...
        <tr>
            ...
            <td class='col-md-8'><?php echo $problem->cpp14_time; ?></td>
