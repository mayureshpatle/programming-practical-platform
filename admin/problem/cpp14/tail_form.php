...
<form action='edit_tail.php' method='post'>  <?php echo $pcode_ip;?>
<div class='col-md-12'>
    <div class='alert bg-info'>
        <h4><b>Tail Code</b></h4>
        <samp>
        <textarea id='textarea' class='form-control' placeholder="Enter Tail Code Here." rows=25 name='code' style='resize: none;' spellcheck='false' ><?php echo $code; ?></textarea>
        </samp>
        <br />
    </div>
</div>
