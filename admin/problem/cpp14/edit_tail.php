...
if($done)
{
    echo "<div class='col-md-12'>
            <div class='alert alert-success'>
                Tail Code has been updated successfully.<br />
...
{
    $save = "Are you sure you want to update the Tail Code? This will overwrite the previously saved code (if any) and will make the status `Not Ready` for this language. This action cannot be undone.";
    $abort = "Do you really want to abort editing the Tail Code? No changes will be made in the code.";
