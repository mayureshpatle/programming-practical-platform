...
if($done)
{
    echo "<div class='col-md-12'>
            <div class='alert alert-success'>
                Locked Tail Code has been updated successfully.<br />
...
{
    $save = "Are you sure you want to update the Locked Tail Code? This will overwrite the previously saved code (if any). This will not change the Ready Status of this language.";
    $abort = "Do you really want to abort editing the Locked Tail Code? No changes will be made in the code.";
    ...
    include_once "locked_tail_form.php";
}
