...
// set page title
$page_title = "Problem: {$problem->pcode} (Python 3 Config -> Testing)";
...
//saved solution
$fpath = "../../../problems/{$problem->pcode}/drivers/py3/testing/{$_SESSION['id']}.txt";
$soln = @fopen($fpath,"a");
@fclose($soln);
$size = filesize($fpath);
if($size)
...
if(isset($_POST['code']))
{
    ...
    $response = $judge->submit_problem($source_code, "PYTHON3", $problem);
