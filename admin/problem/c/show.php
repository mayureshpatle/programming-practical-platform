...
$status = ( $problem->c ?  "<b>Enabled</b> " : "<b>Disabled</b> " ) . ( $problem->c_ready ? "<big><span class='label label-lg label-success'>Ready</span></big>" : "<big><span class='label label-lg label-danger'>Not Ready</span></big>" );
$btn = $problem->c ? "class='btn btn-md btn-block btn-danger'" : "class='btn btn-md btn-block btn-primary'";
$new_status = $problem->c ? "Disable" : "Enable";
$action = $problem->c ? "disable.php" : "enable.php";
$status_warn = "Are you sure you want to {$new_status} this language?";

//description
$fpath = "../../../problems/{$problem->pcode}/drivers/c/description.txt";
$size = filesize($fpath);
if($size)
{
    $desc = fopen($fpath,"r");
...
//tail code
$fpath = "../../../problems/{$problem->pcode}/drivers/c/tail.txt";
$size = filesize($fpath);
if($size)
{
    $desc = fopen($fpath,"r");
...
//locked head code
$fpath = "../../../problems/{$problem->pcode}/drivers/c/locked_head.txt";
$size = filesize($fpath);
if($size)
{
    $desc = fopen($fpath,"r");
...
//locked tail code
$fpath = "../../../problems/{$problem->pcode}/drivers/c/locked_tail.txt";
$size = filesize($fpath);
if($size)
{
    $desc = fopen($fpath,"r");
...
<div class='col-md-12'>
    <table class='table table-hover'>
        ...
        <tr>
            ...
            <td class='col-md-8'><?php echo $problem->c_time; ?></td>
