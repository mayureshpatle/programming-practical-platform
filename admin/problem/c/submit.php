...
// set page title
$page_title = "Problem: {$problem->pcode} (C Config -> Testing)";
...
//saved solution
$fpath = "../../../problems/{$problem->pcode}/drivers/c/testing/{$_SESSION['id']}.txt";
$soln = @fopen($fpath,"a");
@fclose($soln);
$size = filesize($fpath);
if($size)
...
if(isset($_POST['code']))
{
    ...
    $response = $judge->submit_problem($source_code, "C", $problem);
