...
$status = ( $problem->java ?  "<b>Enabled</b> " : "<b>Disabled</b> " ) . ( $problem->java_ready ? "<big><span class='label label-lg label-success'>Ready</span></big>" : "<big><span class='label label-lg label-danger'>Not Ready</span></big>" );
$btn = $problem->java ? "class='btn btn-md btn-block btn-danger'" : "class='btn btn-md btn-block btn-primary'";
$new_status = $problem->java ? "Disable" : "Enable";
$action = $problem->java ? "disable.php" : "enable.php";
...
<div class='col-md-12'>
    <table class='table table-hover'>
        ...
        <tr>
            ...
            <td class='col-md-8'><?php echo $problem->java_time; ?></td>
